  ...
  function PaintSurface(
    ...
    return (
      ...
      >
        ...
        <SurfaceContext.Provider value={ctx}>{children}</SurfaceContext.Provider>
      </div>
    );
  },
);
...
export function PaintFrame<E extends ElementType = "div">(
  {
    ...
    children,
    ...rest
  }: PaintFrameProps<E> & Omit<ComponentPropsWithoutRef<E>, keyof PaintFrameProps<E>>,
) {
  ...
  return (
    <>
      {Children.map(children, (child) => {
        ...
        if (typeof (child.props as PaintFrameProps).delay === "number") return child;
