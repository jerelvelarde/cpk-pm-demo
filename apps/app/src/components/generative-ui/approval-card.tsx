    ...
    >
      ...
      <div className="space-y-2">
        ...
        <FieldRow
          label="Priority"
          current={
            <PriorityChip priority={issue.priority as IssuePriority} />
          }
          proposed={
        ...
        <FieldRow
          label="Assignee"
          current={
            <AssigneeChip assignee={issue.assignee ?? null} />
          }
          proposed={
            <AssigneeChip assignee={merged.assignee ?? null} />
          }
          editing={editing}
          render={(_, set) => (
            <select
              ...
              onChange={(e) =>
                set("assignee", e.target.value || null)
              }
              style={selectStyle}
            >
          ...
          onChange={(v) =>
            setLocalChanges((c) => ({ ...c, assignee: v }))
          }
        />
      </div>
    ...
    >
      ...
      {editing ? (
        ...
        <div className="flex items-center gap-2 text-[12px]">
          {!same && (
            <>
              <span style={{ color: "#838389", textDecoration: "line-through" }}>
                {current}
              </span>
...
function AssigneeChip({ assignee }: { assignee: string | null }) {
  if (!assignee) {
    return (
      <span style={{ fontSize: 11, color: "#838389" }}>Unassigned</span>
    );
  }
  return (
